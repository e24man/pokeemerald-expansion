...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_GALE_WINGS, ABILITY_BIG_PECKS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_GALE_WINGS, ABILITY_BIG_PECKS },
        .bodyColor = BODY_COLOR_RED,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_UNBURDEN, ABILITY_NONE, ABILITY_SWEET_VEIL },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_SAND_VEIL, ABILITY_DRY_SKIN },
